...
class DeepSeekProvider(BaseProvider):
    ...
    def __init__(self, model_tag: str, api_key: str, api_base: str = "https://api.deepseek.com/v1"):
        """
        Initialize a DeepSeek provider.
        
        Args:
            model_tag: DeepSeek-specific model identifier (e.g. "deepseek-coder")
            api_key: DeepSeek API key
            api_base: DeepSeek API base URL
        """
        super().__init__(Provider.DEEPSEEK, model_tag, api_key)
    ...
    async def send_message_non_streaming(self, message: str):
        ...
        # TODO: Implement proper DeepSeek non-streaming
        logger.warning("DeepSeek non-streaming implementation needed")
        ...
        return {
            ...
            "choices": [{"message": {"content": "DeepSeek non-streaming not implemented"}, "finish_reason": "stop"}],
