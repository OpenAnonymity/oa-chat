...
/**
 * Create a blinded token request (matching Python create_token_request)
 *
 * Takes a WWW-Authenticate header and number of tokens to request (nr)
 * Returns [ClientState, TokenRequest] as JSON string
...
/**
 * Finalize a token (unblind) - matching Python finalize_token
 *
 * Takes header, client state, and token response
 * Returns { tokens: [token], error: "" } as JSON string
 * @param {string} _header_s
 * @param {string} client_state_s
 * @param {string} token_response_s
 * @returns {Promise<string>}
 */
export function token_finalization(_header_s, client_state_s, token_response_s) {
    const ptr0 = passStringToWasm0(_header_s, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbindgen_cast_d0201660226fd4b0 = function(arg0, arg1) {
        ...
        const ret = makeMutClosure(arg0, arg1, 103, __wbg_adapter_10);
        return ret;
    };
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('oa_inference_ticket_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
