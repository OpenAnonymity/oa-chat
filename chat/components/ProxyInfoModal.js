            ...
            <div class="bg-background border border-border rounded-xl shadow-2xl max-w-md w-full mx-4 animate-in zoom-in-95 overflow-hidden">
                ...
                <div class="p-4 space-y-4">
                    <div class="space-y-3 text-sm text-foreground">
                        <p>
                            OA provides an <strong>in-browser, VPN-like encrypted tunnel</strong> for your API requests, hiding your IP/metadata side-channels from the model provider.
                        </p>
                        ...
                        <div class="p-3 rounded-lg border border-border bg-slate-100 dark:bg-slate-800/50 space-y-2">
                            ...
                            <ul class="text-xs space-y-1.5 text-slate-600 dark:text-slate-300">
                                ...
                                <li class="flex items-start gap-2">
                                    <span class="text-blue-500 mt-0.5">→</span>
                                    <span>Inside that WebSocket, we establish a separate <strong class="text-foreground">TLS tunnel</strong> (using mbedTLS/WASM)</span>
                                </li>
                                <li class="flex items-start gap-2">
                                    <span class="text-blue-500 mt-0.5">→</span>
                                    <span>Your API requests travel through this encrypted tunnel to the model provider</span>
                                </li>
                            </ul>
                        </div>
