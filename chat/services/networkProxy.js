...
class NetworkProxy {
    ...
    parseTlsOutput(text) {
        ...
        // Verbose transport lines can contain credentials or request content.
        // Keep parsed TLS metadata only; never retain those raw lines.
...
if (typeof window !== 'undefined') window.networkProxy = networkProxy;
